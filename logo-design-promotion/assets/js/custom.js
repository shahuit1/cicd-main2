...
document.addEventListener("DOMContentLoaded", function () {
  const input = document.querySelector("#phone-banner");
  // const button = document.querySelector("#banner-submit");
  const errorMsg = document.querySelector("#error-msg-banner");
  const validMsg = document.querySelector("#valid-msg-banner");
...
// Logo Types Carousel JS
$(document).ready(function () {
  $("#logo-types-carousel").owlCarousel({
    loop: true,
    margin: 0,
    dots: false,
    autoplay: true,
